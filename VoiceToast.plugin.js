...
const DEFAULTS = {
  ...
  notifs: {
    mute: { enabled: true, message: "mute" },
    unmute: { enabled: true, message: "unmute" },
    deafen: { enabled: true, message: "deafen" },
    undeafen: { enabled: true, message: "undefen" },
    join: { enabled: true, message: "$user join $channel" },
    leave: { enabled: true, message: "$user leave $channel" },
    joinSelf: { enabled: true, message: "you join $channel" },
    moveSelf: { enabled: true, message: "you are moved to $channel" },
    leaveSelf: { enabled: true, message: "you leave $channel" },
  },
...
/* =======================
   Store-based tracking (BD 1.13.5 )
======================= */
